...
И даже тогда, когда теряет объект из вида: 
...
Настройка RaspberryPi начинается с установки на нее raspberryOS. Я ставил bookworm версию, на всякий случай сохранил образ [ТУТ](https://disk.yandex.ru/d/wgu7vjcfcwhprQ). После этого в домашнюю директорию нужно склонировать репозиторий и установить докер-контейнер с ROS2:
```
bash robot.sh
```
...
На хосте:
- терминал 1: `ros2 launch robot keyboard teleop`
- терминал 2: `rqt`
